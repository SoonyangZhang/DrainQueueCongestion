...
//paper: Elastic-TCP: Flexible Congestion Control Algorithm to Adapt for High-BDP Networks
namespace dqc{
class RttStats;
class TcpElasticSenderBytes : public SendAlgorithmInterface {
 public:
  TcpElasticSenderBytes(const ProtoClock* clock,
                      const RttStats* rtt_stats,
                      QuicPacketCount initial_tcp_congestion_window,
                      QuicPacketCount max_congestion_window,
                      QuicConnectionStats* stats);
  TcpElasticSenderBytes(const TcpElasticSenderBytes&) = delete;
  TcpElasticSenderBytes& operator=(const TcpElasticSenderBytes&) = delete;
  ~TcpElasticSenderBytes() override;
