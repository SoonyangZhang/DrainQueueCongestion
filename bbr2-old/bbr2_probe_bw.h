...
class QUIC_EXPORT_PRIVATE Bbr2ProbeBwMode final : public Bbr2ModeBase {
 public:
  ...
  struct DebugState {
    CyclePhase phase;
    ProtoTime cycle_start_time = ProtoTime::Zero();
    ProtoTime phase_start_time = ProtoTime::Zero();
  };
 ...
 private:
  ...
  bool HasStayedLongEnoughInProbeDown(
      const Bbr2CongestionEvent& congestion_event) const;
  bool HasCycleLasted(TimeDelta duration,
                      const Bbr2CongestionEvent& congestion_event) const;
  bool HasPhaseLasted(TimeDelta duration,
                      const Bbr2CongestionEvent& congestion_event) const;
  ...
  struct Cycle {
    ...
    TimeDelta probe_wait_time = TimeDelta::Zero();
